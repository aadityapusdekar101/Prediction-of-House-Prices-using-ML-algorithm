...
## Set up tuning grid
#caretGrid <- expand.grid(interaction.depth=c(1, 3, 5,6), n.trees = (0:40)*50,
# shrinkage=c(0.01, 0.02),
# n.minobsinnode=2)
caretGrid <- expand.grid(interaction.depth=c(1,3,4,6), n.trees = (0:40)*50,
...
gb# assign to params and inspect
